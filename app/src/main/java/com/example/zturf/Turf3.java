...
public class Turf3 extends AppCompatActivity {
    Button but;
    TextView textView;
    Calendar calendar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turf3);

        but = findViewById(R.id.button23);
    ...
    private void showDatePicker() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(Turf3.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    private void showTimePicker() {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(Turf3.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                ...
                ProgressDialog progressDialog = new ProgressDialog(Turf3.this);
                ...
                new Handler().postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(Turf3.this, "Booking Successful!", Toast.LENGTH_LONG).show();
                    }
                }, 3000);
            }
        }, hour, minute, false);
